...
<body>
    ...
    require "../contatos/listar_contatos.php";
    ?>

    <div style="padding-top: 50px;">
        <div class="footer-table-container">
            <h4 style="">O total de Contatos: <?php echo $_SESSION['num_linhas']; ?></h4><br>
            <div class="table-container table-responsive-sm">
                <?php
                if (count($contatos) > 0) {
                ?>
                    <h3 style="text-align: center;">Usuarios que entraram em contato</h3><br>
                    <table class="table table-striped table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            foreach ($contatos as $contato) {
                                ...
                                echo "<td>
                                        <form method='post' action='../contatos/excuir_contatos.php'>
